...
import static BloodDonor.RegistrationUI.jComboBox1;
import static BloodDonor.RegistrationUI.jPasswordField1;
import static BloodDonor.RegistrationUI.jPasswordField2;
import static BloodDonor.RegistrationUI.jTextField1;
import static BloodDonor.RegistrationUI.jTextField10;
import static BloodDonor.RegistrationUI.jTextField2;
import static BloodDonor.RegistrationUI.jTextField4;
import static BloodDonor.RegistrationUI.jTextField6;
import static BloodDonor.RegistrationUI.jTextField8;
import static BloodDonor.RegistrationUI.male;
 ...
 * @author Nur_Islam
 */
public class RegistrationUI2 extends javax.swing.JFrame {

    /**
     * Creates new form RegistrationUI2
     */
    public RegistrationUI2() {
        initComponents();
    ...
    public boolean verifyFields(){
        ...
        if(fname.trim().equals("") || email.trim().equals("") || pass1.trim().equals("") || pass2.trim().equals("") || phone.trim().equals("") || address.trim().equals("") ||nationalId.trim().equals("") || sq.trim().equals("") || username.trim().equals("") || bloodtype.trim().equals("")){
    ...
    public boolean checkUnique(String username,String email,String phone){
        PreparedStatement st;
        ResultSet rs;
        
        boolean username_exist = false;
        
        String query = "SELECT * FROM `verified_user` WHERE `Username` = ? OR `Email` = ? OR `Contact` = ?";
        ...
        try {
            ...
            if(rs.next()){
                username_exist = true;
                JOptionPane.showMessageDialog(null,"Username,Email or Phone number already Registered\nPlease use new one","Email problem",2);
            }
        } catch (SQLException ex) {
            Logger.getLogger(RegistrationUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        query = "SELECT * FROM `unverified_user` WHERE `Username` = ? OR `Email` = ? OR `Contact` = ?";
    ...
    private void initComponents() {
        ...
        Complete.setText("Update Documents");
    ...
    private void CompleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CompleteActionPerformed
        ...
        if(verifyFields()){
            if(!checkUnique(username,email,phone)){
                //PreparedStatement st;
                ResultSet rs;
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Your Account will be updated soon\nPlease wait for the verification");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrationUI2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrationUI2().setVisible(true);
            }
        });
    }
